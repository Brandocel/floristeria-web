  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 px-8 text-center">
      ...
      <button
        type="button"
        onClick={onClose}
        className="group inline-flex h-[50px] min-w-[180px] items-center justify-center border border-[#D8C9B8] bg-transparent px-7 font-[var(--font-serif)] text-[16px] text-[#2C2C2C] transition-all duration-300 hover:border-[#DBCCBA] active:scale-[0.98]"
      >
        <span className="relative flex h-full w-full items-center justify-center overflow-hidden">
          <span className="absolute inset-0 origin-left scale-x-0 bg-[#DBCCBA] transition-transform duration-300 group-hover:scale-x-100" />
              ...
              <>
                ...
                <div className="border-t border-[#DBCCBA] px-7 pb-8 pt-5">
                  ...
                  <a
                    ...
                    className="group flex h-[58px] w-full items-center justify-center border border-[#2C2C2C] bg-[#2C2C2C] px-6 font-[var(--font-serif)] text-[18px] font-normal text-[#F8F3EC] transition-all duration-300 hover:bg-transparent hover:text-[#2C2C2C] active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#DBCCBA] focus-visible:ring-offset-2"
                  >
